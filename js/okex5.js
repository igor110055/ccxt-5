...
module.exports = class okgunbot extends Exchange {
    describe () {
    ...
    async fetchTickers (symbols = undefined, params = {}) {
        if (_.isNil(global["okgunbot"]))global["okgunbot"] = {}
        global["okgunbot"].coins = await this.loadMarkets ();
    ...
    async fetchOHLCV (symbol, timeframe = '1m', since = undefined, limit = undefined, params = {}) {
        ...
        const type = defaultType//this.safeString (params, 'type', defaultType);
    ...
    async createOrder (symbol, type, side, amount, price = undefined, params = {},mark,pSide) {
        await this.loadMarkets ();
        const market = this.market (symbol);
        ...
        const request = {
            ...
            //     - Isolated FUTURES/SWAP/OPTION: isolated
            //
            'tdMode': mark == 'spot' ? 'cash' : "cross", // cash, cross, isolated
            // 'ccy': currency['id'], // only applicable to cross MARGIN orders in single-currency margin
            'clOrdId': "ebe146d82f8f4fBC"+num, // up to 32 characters, must be unique
            ...
            //
            'side': side,
            'posSide': pSide, // long, short, // required in the long/short mode, and can only be long or short
        ...
        if (type === 'market') {
            ...
            if (side === 'buy') {
                ...
                const createMarketBuyOrderRequiresPrice = false//this.safeValue (this.options, 'createMarketBuyOrderRequiresPrice', true);
    ...
    async fetchMyTrades (symbol = undefined, since = undefined, limit = undefined, params = {}) {
        const request = {
            'instType': params.type.toUpperCase(), // SPOT, MARGIN, SWAP, FUTURES, OPTION
            // 'uly': currency['id'],
            //'instId': market['id'],
            // 'ordId': orderId,
            // 'after': billId,
